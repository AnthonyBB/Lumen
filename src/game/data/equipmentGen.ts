...
//
// IMPORTANT: a byte-identical copy of this generator lives at
// server/game/data/equipmentGen.ts (with a local SkillClass
// definition instead of the skillTrees import, because the
// server tsconfig cannot reach into src/).  If you change ANY
// generation logic, constants or part lists here, you MUST make
// the same change there — otherwise client and server will
// disagree on item data.
// ============================================================

import type { SkillClass } from './skillTrees'
